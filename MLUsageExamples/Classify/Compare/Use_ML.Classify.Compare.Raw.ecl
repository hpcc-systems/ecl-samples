/*
   The ML.Classify.Compare.Raw definition returns a detailed
   breakdown of every record in the inputted datasets including
   what the classification should have been (dep) and what
   it was (computed)
