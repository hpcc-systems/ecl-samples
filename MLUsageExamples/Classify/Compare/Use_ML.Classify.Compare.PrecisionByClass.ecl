/*
   The ML.Classify.Compare.PrecisionByClass definition returns
   the precision broken down by the class that it should have
   been classified to.
...
*/
   ...
   OUTPUT(cmp.PrecisionByClass,NAMED('cmp_PrecisionByClass'));
