/*
   The ML.Classify.Compare.CrossAssignments definition returns
   for each record if a class is misclassified, what is it
   most likely to be misclassified as.
...
*/
   ...
   OUTPUT(cmp.CrossAssignments,NAMED('cmp_CrossAssignments'));
