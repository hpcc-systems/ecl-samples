/*
   The ML.Classify.Compare.FP_Rate_ByClass definition returns
   the percentage of instances not belonging to a class that
   were incorrectly classified as this class.
...
*/
   ...
   OUTPUT(cmp.FP_Rate_ByClass,NAMED('cmp_FP_Rate_ByClass'));
