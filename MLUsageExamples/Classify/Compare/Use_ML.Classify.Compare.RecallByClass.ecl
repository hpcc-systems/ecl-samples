/*
   The ML.Classify.Compare.RecallByClass definition returns the
   recall broken down by the class that it should have been
   classified to.
...
*/
   ...
   OUTPUT(cmp.RecallByClass,NAMED('cmp_RecallByClass'));
